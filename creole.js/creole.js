...
(function() {
  var exports, headingRuleTable, image, inLinkText, inListItem, inParagraph, inRoot, inTableCell, itemPrefixes, linkOptions, linkPattern, linkPatterns, linkTextMarkups, match, parse, parseHeading, parseLine, parseLinkText, parseList, parseNowiki, parseParagraph, parseTable, parseTableRow, parseText, rawUrl, rootPrefixes, skipWhitespace, style_BOLD, style_BOLD_ITALICS, style_ITALICS, style_ITALICS_BOLD, style_NONE, textMarkups, urlPrefix, _ref;
  ...
  textMarkups = [linkTextMarkups, '\\[\\[(?:' + linkPatterns + ')(?:\\||\\]\\])', rawUrl, '~(?:' + rawUrl + '|.)'].join('|');
